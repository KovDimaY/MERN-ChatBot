export const cardItemData = {
  ...
  link:
    'https://www.telegraph.co.uk/technology/news/11048695/Monkeys-ghosts-and-gods-cannot-own-copyright-says-US.html',
};
...
export const cardsData = {
  value: [
    ...
    },
    {
      ...
      title: 'Second card',
      image:
        'https://www.sciencemag.org/sites/default/files/styles/inline__450w__no_aspect/public/cc_BE6RJF_16x9.jpg',
      description:
        'Morbi vulputate felis ut risus convallis consectetur. Pellentesque non leo ligula. Pellentesque convallis, risus egestas aliquam venenatis, nibh sapien pharetra sem, nec lobortis velit lacus nec nisi. Suspendisse vel pulvinar magna.',
      link:
    ...
    },
    {
      ...
      link:
        'https://www.express.co.uk/news/uk/696974/Ghost-rude-monkey-shocks-visitors-stately-home-Dorset',
    },
  ],
};
